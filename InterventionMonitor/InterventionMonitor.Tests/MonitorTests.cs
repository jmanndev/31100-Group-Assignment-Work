...
namespace InterventionMonitor.Tests
{
    ...
    public class MonitorTests
    {
        ...
        x New client is created with name "Josiah".
        x mosquito net intervention is created for "Josiah".
        ...
        x site engineer cannot create intervention for client in different district.
